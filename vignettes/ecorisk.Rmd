...
<img src="images/ecorisk_logo.png" alt="ecorisk logo" align="right" width="100" height="112"/>
...
The ecorisk package supports the ecorisk framework [@gutte2026] by providing  
tools for analysis, assessment and communication. The
...
# The ecorisk package theory {#ecorisk-theory}

The ecorisk package supports the ecorisk framework [@gutte2026]. It provides 
functions for the semiquantitative expert scoring
...
using the functions `create_template_exposure()` and `create_template_sensitivity()`. The output
can be saved as csv or excel file. After they have been filled out by
the experts, they can directly be analyzed further with the ecorisk
workflow. 
...
`create_template_sensitivity()`, we can automatically create tables for further
